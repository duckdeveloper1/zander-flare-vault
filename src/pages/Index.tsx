...
import { ChevronLeft, ChevronRight, Zap, Star, TrendingUp } from "lucide-react";
      ...
      <section className="py-16 bg-gradient-to-r from-primary/10 to-primary-glow/10">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="border-primary/20">
              <CardContent className="p-6 text-center">
                <h3 className="text-2xl font-bold mb-2 text-foreground">30% OFF</h3>
                <p className="text-muted-foreground mb-4">
                  Na primeira compra
                </p>
                <Link to="/catalog">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="group hover:shadow-lg transition-all duration-300">
              ...
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-2 text-foreground">
                  Conjunto Casual Urban
                </h3>
                <p className="text-muted-foreground mb-4">
                  Camiseta + Calça + Tênis perfeitamente combinados
                </p>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300">
              ...
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-2 text-foreground">
                  Conjunto Elegante Pro
                </h3>
                <p className="text-muted-foreground mb-4">
                  Para ocasiões especiais com muito estilo
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-primary">
                    R$ 559,90
